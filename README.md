...
- [Technologies Used](#technologies-used)
    ...
    - [Backend](#backend)
    - [Frontend](#frontend)
    - [Code Formatting with Prettier in ReactJS - ![Prettier Shield Badge]https://img.shields.io/badge/Prettier-%23F7B93E?style=for-the-badge&logo=prettier&logoColor=white](#code-formatting-with-prettier-in-reactjs---prettier-shield-badgehttpsimgshieldsiobadgeprettier-f7b93estylefor-the-badgelogoprettierlogocolorwhite)
...
-   The platform was viewed on a variety of devices such as Desktop, Laptop, iPhone11,
    -   [iphone11-1](https://res.cloudinary.com/pjdevex/image/upload/v1701041486/vistascape/test/ip1_xytcun.jpg)
    -   [iphone11-2](https://res.cloudinary.com/pjdevex/image/upload/v1701041486/vistascape/test/ip2_oglpjk.jpg)
    -   [iPhone11-3](https://res.cloudinary.com/pjdevex/image/upload/v1701041486/vistascape/test/ip3_nhlzdj.jpg)
...
- **Files:** Comprising 16 customized CSS files, notably [/vistascape/frontend/src/App.module.css](https://github.com/PJDEVEX/vistascape/blob/main/frontend/src/App.module.css), and others located in [/vistascape/frontend/src/styles](https://github.com/PJDEVEX/vistascape/tree/main/frontend/src/styles).
